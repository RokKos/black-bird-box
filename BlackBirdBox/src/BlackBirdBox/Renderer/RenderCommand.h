...
public:
    ...
    static void DrawPoints(const std::vector<Ref<Point>>& points) { s_RendererAPI->DrawPoints(points); }
    ...
    static void WaitMemoryBarrier() { s_RendererAPI->WaitMemoryBarrier(); }

    static void SetPolygonMode(RendererAPI::PolygonMode mode) { s_RendererAPI->SetPolygonMode(mode); }

    static void SetDepthFunction(RendererAPI::DepthFunction depth_function) { s_RendererAPI->SetDepthFunction(depth_function); }

    static void Enable(RendererAPI::RenderCapabilities capability) { s_RendererAPI->Enable(capability); }

    static void Disable(RendererAPI::RenderCapabilities capability) { s_RendererAPI->Disable(capability); }
