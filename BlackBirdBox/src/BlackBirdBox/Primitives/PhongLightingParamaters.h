...
struct PhongLightingParameters {
    ...
    {
        return diffuse_color_ == other.diffuse_color_ && specular_color_ == other.specular_color_
            && specular_scattering_ == other.specular_scattering_ && ambient_color_ == other.ambient_color_
            && ambient_intensity_ == other.ambient_intensity_;
    }
};
}
