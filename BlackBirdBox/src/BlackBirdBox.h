...
// Note(Rok Kos): Macros needs to be behind ImGui, because it includes Windows.h, look at this issue for further explanation:
...
#include "BlackBirdBox/Audio/AudioSample.h"
