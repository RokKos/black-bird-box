...
size_t OpenGLShaderStorageArray::AddShaderStorageBuffer(const BlackBirdBox::Ref<BlackBirdBox::ShaderStorageBuffer>& shader_storage_buffer)
{
    PROFILE_FUNCTION();
...
void OpenGLShaderStorageArray::SetShaderStorageBuffer(int id, const BlackBirdBox::Ref<BlackBirdBox::ShaderStorageBuffer>& shader_storage_buffer)
{
    PROFILE_FUNCTION();
